...
def test_defaults_when_no_env() -> None:
    ...
    # El docker-compose del proyecto inyecta el prompt específico de Shiro.
...
def test_env_overrides_apply() -> None:
    with env(
        ...
        WHISPER_INITIAL_PROMPT="El usuario habla con Aiko, una asistente.",
    ):
        cfg = Config.from_env()
    ...
    assert cfg.initial_prompt == "El usuario habla con Aiko, una asistente."
