...
Post-MVP: **Modo overlay** (toggle a ventana flotante always-on-top, ADR 0024 §3), **Self-improvement** (propose-only, [ADR 0023](docs/adr/0023-shiro-self-improvement-propose-only.md), reusa el slot agentic), Plugins, Mobile, Avatar 3D (VRM), Arduino bridge, IoT bridge.
